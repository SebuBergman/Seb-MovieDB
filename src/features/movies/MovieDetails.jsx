...
function MovieDetails() {
  ...
  const movieDate = data?.release_date.split("-").reverse().join(".");
        ...
        <Stack>
          <CardBody>
            ...
            <Text py="2" color="gray.600">
              ...
              Vote Count: <Badge>{data?.vote_count}</Badge>
            </Text>
            <Text py="2">Release date: {movieDate}</Text>
            <Text py="">{data.overview}</Text>
          </CardBody>
